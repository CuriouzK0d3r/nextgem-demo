      ...
      {uploadSuccess ? (
        ...
        <div className="form-control w-full mx-auto">
          <div className="flex items-center justify-center w-full">
            <label className="flex flex-col items-center justify-center w-full h-72 border-8 border-gray-200 border-dashed rounded-lg cursor-pointer bg-[#D4D9DD]">
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p className="mb-2 text-md text-gray-900 dark:text-gray-400">
                  Drop .json files to attach, or
          ...
          <Button
            placeholder={""}
            id="uploadBtn"
            onClick={() => console.log(fileStatus)}
            type="submit"
            className="btn font-bold w-30 h-12 mt-8"
            variant="gradient"
          >
            Upload Files
          </Button>
