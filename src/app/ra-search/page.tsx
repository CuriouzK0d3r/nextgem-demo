            ...
            <div className="menu-box members-cat mr-8">
              <div className=" w-full h-full text-center rounded-lg object-cover object-center shadow-2xl shadow-blue-gray-900/50">
                <img
                  ...
                  alt=""
                />
                <span className="text-white">New Risk Assesment</span>
              </div>
            </div>
          </a>
            ...
            <div className="menu-box members-cat">
              <div className="w-full h-full text-center rounded-lg object-cover object-center shadow-2xl shadow-blue-gray-900/50">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="mx-auto pt-10 w-20 text-white"
                >
                  <path
                    strokeLinecap="round"
                ...
                <span className="text-white">Existing Risk Assesment</span>
              </div>
            </div>
          </a>
