    ...
    <PageLayout checkLogin={true} isLoggedIn={isLoggedIn} pageName="Input">
      <div className="w-full mt-40 min-h-[60rem]">
        <Card
          ...
          placeholder={""}
          className="mt-6 w-full lg:w-1/2 xl:1/3 mx-auto form-container object-cover object-center shadow-[0_10px_50px_rgba(58,_65,_11,_0.8)]"
        >
          <CardHeader
            placeholder={""}
            className="bg-[#D4D9DD] text-black p-0 divide-y-2 divide-[#fff]"
          >
            <Typography
              placeholder={""}
              variant="h1"
            ...
            <div className="tab bt-2 object-cover object-center shadow-3xl shadow-blue-gray-900/50 ">
              <button
                ...
                className={
                  "tablinks " + (activeTab === "formTab" ? "active" : "")
                }
                onClick={event => setActiveTab("formTab")}
              >
              ...
              <button
                style={{ borderRadius: "4px 4px 0 0" }}
                className={
                  "tablinks " + (activeTab === "fileTab" ? "active" : "")
                }
                onClick={event => setActiveTab("fileTab")}
              >
                Input Files
              </button>
            </div>
          ...
          <CardBody placeholder={""}>
            <div
              id="formTab"
              className={" " + (activeTab === "formTab" ? "block" : "hidden")}
            >
              <form className="mt-4" id="inputForm" onSubmit={uploadForm}>
                        ...
                        if (inputField.type === "text") {
                          return (
                            <div key={index} className="flex flex-row mt-4 p-0">
                              <Input
                                required
                                key={index}
                                className="object-cover bg-white object-center shadow-inner shadow-blue-gray-900/50"
                                value={inputState[inputField.field]}
                                onChange={(event: any) => {
                                  event.preventDefault();
                                  setInputState({
                                    ...inputState,
                          ...
                          return (
                            <div key={index} className="flex flex-row mt-4 p-0">
                              <Select
                                key={index}
                                className="object-cover bg-white object-center shadow-inner shadow-blue-gray-900/50 text-black"
                                label={inputField.label}
                ...
                <div>
                  <Button
                    placeholder={""}
                    className="clear-button font-bold w-30 h-12 mr-4"
                    variant="gradient"
                    onClick={clearState}
                  >
                    Clear
                  ...
                  <Button
                    ...
                    id="searchBtn"
                    type="submit"
                    className="btn font-bold w-30 h-12 mr-4"
                    variant="gradient"
                  >
                    Upload
                  </Button>
            ...
            <div
              ...
              className={
                "h-[450px] mt-12 " +
                (activeTab === "fileTab" ? "block" : "hidden")
              }
            >
              <Typography variant="h5" placeholder={"Description"}>
