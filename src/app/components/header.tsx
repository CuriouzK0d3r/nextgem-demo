      ...
      >
        ...
        >
          <nav className="relative w-full top-0 p-0">
            <div
              className="ast-primary-header-bar ast-primary-header main-header-bar site-header-focus-item snipcss-g39h2"
              ...
              >
                <div className="ast-builder-grid-row ast-builder-grid-row-has-sides ast-builder-grid-row-no-center">
                  <div className="site-header-primary-section-left site-header-section ast-flex site-header-section-left">
                    ...
                    >
                      <div
                        className="site-branding ml-2 ast-site-identity"
                        itemType="https://schema.org/Organization"
                      >
                        <span className="site-logo-img ">
                          <a
                            href="https://subra.ics.forth.gr/"
                          ...
                          >
                            <img
                              width={120}
                              height={34}
                              src="https://subra.ics.forth.gr/wp-content/uploads/2024/01/NIKH-logoname-120x34.png "
                              className="custom-logo p-0"
                              alt=""
                              decoding="async"
                            />
                          </a>
                          {/* <a href="https://subra.ics.forth.gr/" className="custom-logo-link ast-transparent-mobile-logo" rel="home" itemProp="url"><img width={120} height={34} src="./NIKH-logoname-120x34.png" className="custom-logo" alt="" decoding="async" /></a> */}
                        </span>
                      </div>
                    </div>
                  </div>
                  <div className="site-header-primary-section-right site-header-section ast-flex ast-grid-right-section">
                          ...
                          >
                            <div className="main-navigation ast-inline-flex">
                              ...
                              >
                                <li
                                  id="menu-item-542"
                                  className="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-540 current_page_item menu-item-542"
                                >
                                  <a
                                    href="https://subra.ics.forth.gr/"
                                    aria-current="page"
                                ...
                                <li
                                  id="menu-item-12"
                                  className="menu-item menu-item-type-post_type menu-item-object-page menu-item-12"
                                >
                                  <a
                                    href="https://subra.ics.forth.gr/stakeholders/"
                                    className="menu-link"
                                  >
                                    Stakeholders
                                  </a>
                                ...
                                >
                                  <a
                                    href="https://subra.ics.forth.gr/citizens/"
                                    className="menu-link"
                                  >
                                    Citizens
                                  </a>
                    ...
                    >
                      {isLoggedIn ? (
                        <div className="ast-builder-button-wrap ast-builder-button-size-">
                          ...
                          >
                            <div
                              ...
                              className="ast-custom-button cursor-pointer"
                            >
                              Logout
                            </div>
                          </a>
                        ...
                        <div className="ast-builder-button-wrap ast-builder-button-size-">
                          <a className="ast-custom-button-link" href="/login">
            ...
            >
              ...
              >
                <div className="elementor-widget-container">
                  ...
                  <h1
                    id="page-title"
                    className="elementor-heading-title elementor-size-default left w-[50rem]"
