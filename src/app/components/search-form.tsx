      ...
      <div className="flex">
        ...
        <div className="relative inline-block flex-1">
          <input
            ...
            type="search"
            id="search-dropdown"
            className="w-full h-[70px] block p-2.5 z-20 text-sm text-gray-900 
        ...
        <div className="flex-none">
          <button
            ...
            type="submit"
            className="w-[100px] absolute top-0 right-0 pl-9 text-sm font-medium h-full text-white bg-blue-500 rounded-r-lg border border-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-700"
          >
            <svg
              className="w-6 h-6"
              aria-hidden="true"
