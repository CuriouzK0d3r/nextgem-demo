      ...
      <div className="flex">
        ...
        <div className="relative inline-block flex-1">
          <input
            ...
            type="search"
            id="search-dropdown"
            className="bg-[#D9D9D9] w-full h-[70px] block p-2.5 z-20 text-sm text-gray-800 
                ...
                "
            placeholder="Search Titles, DOIs, Authors, Subjects"
            required
          />
        </div>
        <div className="flex-none">
          <button
            ...
            type="submit"
            className="w-[100px] absolute top-0 right-0 pl-6 text-sm font-medium h-full text-white bg-[#1D2E66] rounded-r-lg border border-blue-500 hover:bg-[#1d3f66] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-[#1d3f66] dark:focus:ring-blue-700"
          >
            <svg
              className="w-12 h-12"
              aria-hidden="true"
