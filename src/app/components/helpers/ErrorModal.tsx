...
const ErrorModal: React.FC<any> = ({ showModal, setShowModal, errorMessage }) => {
    const handleOpen = () => setShowModal(!showModal);

    return (
        <>
            <Dialog placeholder={""} open={showModal} handler={handleOpen}>
                <DialogBody placeholder={""} className="grid place-items-center gap-4">
                    <svg
