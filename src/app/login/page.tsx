  ...
  function submitLoginForm(event: any) {
    ...
    fetch(apiEndpoint, {
      ...
      .then(async response => {
        if (response.ok) {
          let responseJSON = await response.json();
          if (responseJSON.status !== 200) alert("Wrong Credentials!");
          else {
    ...
    <PageLayout pageName="Login" isLoggedIn={true} checkLogin={false}>
      <div className="relative min-h-[48rem] mx-auto auth-container w-[40rem] ">
        ...
        <Card
          ...
          placeholder={""}
          className="form-container w-full mx-auto form-container mt-0 rounded-lg object-cover object-center shadow-[0_10px_50px_rgba(58,_65,_11,_0.8)]"
        >
          <CardBody placeholder={""}>
            <div className="tab">
              <button
                className={
                  "tablinks " + (activeTab === "loginTab" ? "active" : "")
                }
                onClick={event => setActiveTab("loginTab")}
              >
                Login
              </button>
              <button
                className={
                  "tablinks " + (activeTab === "registerTab" ? "active" : "")
                }
                onClick={event => setActiveTab("registerTab")}
              >
                Register
              </button>
            </div>
            ...
            <div
              id="loginTab"
              className={activeTab === "loginTab" ? "block " : "tabcontent "}
            >
              {/* <h3>Login</h3> */}
              <form
                className="mt-12"
              ...
              >
                <Input
                  className="object-cover bg-white p-0 object-center shadow-inner shadow-blue-gray-900/50 "
                  size="lg"
                  crossOrigin="true"
                  id="loginUsername"
                ...
                <Input
                  className="bg-white p-0 object-cover object-center shadow-inner shadow-blue-gray-900/50"
                  size="lg"
                  crossOrigin="true"
                  id="loginPassword"
                ...
                <Button
                  ...
                  id="loginBtn"
                  type="submit"
                  className="clear-button text-md font-bold w-full h-12 mt-8 rounded-lg object-cover object-center shadow-lg shadow-blue-gray-900/50"
                  variant="gradient"
                >
                  Login
                </Button>
            ...
            <div
              id="registerTab"
              className={activeTab === "registerTab" ? "block " : "tabcontent "}
            >
              <form
                className={"mt-4 "}
                id="registerForm"
                onSubmit={event => submitRegisterForm(event)}
              >
                ...
                <Button
                  ...
                  id="searchBtn"
                  type="submit"
                  className="clear-button text-md font-bold w-full h-12 mt-8"
                  variant="gradient"
                >
                  Register
                </Button>
