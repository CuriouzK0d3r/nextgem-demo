            ...
            <form className='flex-1' onSubmit={handleSearch}>
                ...
                dark:focus:border-blue-500" placeholder={placeholder} required />
                    ...
                    <div className='flex-none'>
                        <button style={{ borderWidth: "2px", borderColor: "#6359E1", borderTopLeftRadius: "8px" }} type="submit" className=" w-[100px] absolute top-0 right-0 pl-6 text-sm font-medium h-[70px] text-white bg-blue-500 rounded-r-lg border border-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-700">
