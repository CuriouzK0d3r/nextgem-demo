  ...
  return (
    <div className=" flex flex-col min-h-screen p-0 w-full bg-white">
      <div className="page-layout flex flex-col min-h-screen w-full gap-0">
        <Header
          isLoggedIn={isLoggedIn || isModalLoggedIn || isLogged}
          pageName={pageName}
        />
          ...
          <Card placeholder={""} className="mx-auto w-full ">
            ...
            >
              ...
              <div className="loginInput p-0">
                <Input
                  className="object-cover object-center shadow-sm shadow-blue-gray-900/50 w-full"
                  size="lg"
                  crossOrigin="true"
                  id="loginUsername"
                  required
                ...
                <Input
                  className="p-0 object-cover object-center shadow-sm shadow-blue-gray-900/50"
                  size="lg"
                  crossOrigin="true"
                  id="loginPassword"
                  type="password"
