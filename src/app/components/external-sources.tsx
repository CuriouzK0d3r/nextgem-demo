  ...
  useEffect(() => {
    if (hasSubmitted) {
      if (chosenSources.length == 0) {
        ...
        setOpen(true);
        setHasSubmitted(false);
      } else submitSearch(inputState);
    }
  }, [hasSubmitted]);

  return (
    <div className="flex flex-col mx-auto w-full mt-10 mb-20">
      <h1 className="text-xl text-black italic decoration-offset-4 decoration-wavy block text-center">
      ...
      <div className=" grid grid-cols-2 gap-x-2 lg:gap-0 lg:grid-cols-5 gap-y-2 mx-auto mt-4 items-center">
        ...
        >
          <img
            ...
            alt="NextGEM"
            className={
              "mr-[18px] p-0 rounded-lg object-cover object-center shadow-lg shadow-blue-gray-900/50"
            }
          />
        </button>
        ...
        <button
          className={""}
          onClick={() => {
            chosenSources.includes("EMF")
              ? setChosenSources(
                  chosenSources.filter(function(e: any) {
                    return e !== "EMF";
                  })
                )
              : setChosenSources([...chosenSources, "EMF"]);
          }}
        >
          <img
            width={105}
            src="./EMF-portal_Button.svg"
            alt="EMF-Portal"
            className={
              chosenSources.includes("EMF")
                ? " custom-bounce chosen-source mr-[12px] p-0 rounded-lg object-cover object-center shadow-2xl shadow-blue-gray-900"
                : "custom-bounce-hover mr-[12px] p-0 rounded-lg object-cover object-center shadow-lg shadow-blue-gray-900/50"
            }
          />
        </button>
        ...
        <button
          className={""}
          onClick={() => {
            chosenSources.includes("Zenodo")
              ? setChosenSources(
                  chosenSources.filter(function(e: any) {
                    return e !== "Zenodo";
                  })
                )
              : setChosenSources([...chosenSources, "Zenodo"]);
          }}
        >
          <img
            width={100}
            src="./Zenodo_Button.svg"
            alt="Zenodo"
            className={
              chosenSources.includes("Zenodo")
                ? " custom-bounce chosen-source mr-[12px] p-0 rounded-lg object-cover object-center shadow-2xl shadow-blue-gray-900"
        ...
        <button
          className={""}
          onClick={() => {
            chosenSources.includes("PubMed")
              ? setChosenSources(
                  chosenSources.filter(function(e: any) {
                    return e !== "PubMed";
                  })
                )
              : setChosenSources([...chosenSources, "PubMed"]);
          }}
        >
          <img
            width={105}
        ...
        <button
          className={""}
          onClick={() => {
            chosenSources.includes("WOS")
              ? setChosenSources(
                  chosenSources.filter(function(e: any) {
                    return e !== "WOS";
                  })
                )
              : setChosenSources([...chosenSources, "WOS"]);
          }}
        >
          <img
            width={100}
        ...
        <button
          className={""}
          onClick={() => {
            chosenSources.includes("NextGEM")
              ? setChosenSources(
                  chosenSources.filter(function(e: any) {
                    return e !== "NextGEM";
                  })
                )
              : setChosenSources([...chosenSources, "NextGEM"]);
          }}
        >
          <img
            width={100}
            src="./NextGEM_Button.svg"
            alt="NextGEM"
            className={
              chosenSources.includes("NextGEM")
                ? "custom-bounce chosen-source mr-[13px] p-0 rounded-lg object-cover object-center shadow-2xl shadow-blue-gray-900 mt-4"
                : "mt-6 custom-bounce-hover mr-[13px] p-0 rounded-lg object-cover object-center shadow-lg shadow-blue-gray-900/50"
            }
          />
        </button>
        ...
        <button
          className={""}
          onClick={() => {
            chosenSources.includes("SEAWave")
              ? setChosenSources(
                  chosenSources.filter(function(e: any) {
                    return e !== "SEAWave";
                  })
                )
              : setChosenSources([...chosenSources, "SEAWave"]);
          }}
        >
          <img
            width={100}
        ...
        <button
          className={""}
          onClick={() => {
            chosenSources.includes("GOLIAT")
              ? setChosenSources(
                  chosenSources.filter(function(e: any) {
                    return e !== "GOLIAT";
                  })
                )
              : setChosenSources([...chosenSources, "GOLIAT"]);
          }}
        >
          <img
            width={100}
        ...
        <button
          className={""}
          onClick={() => {
            chosenSources.includes("ETAIN")
              ? setChosenSources(
                  chosenSources.filter(function(e: any) {
                    return e !== "ETAIN";
                  })
                )
              : setChosenSources([...chosenSources, "ETAIN"]);
          }}
        >
          <img
            width={100}
