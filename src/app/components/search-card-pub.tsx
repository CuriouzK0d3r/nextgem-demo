...
const SearchCardPub: React.FC<any> = ({
  document,
  index,
  setShowModal,
  setPaperAbstract
  ...
  return (
    <div className=" rounded-lg border-none p-0">
      <Card
        placeholder={""}
        className="w-full mb-4 pt-6 hover:bg-[#eee]  bg-[#D9D9D9] object-cover object-center shadow-xl shadow-blue-gray-900/50"
      >
        <div className="flex">
          ...
          <div className="float-right w-1/6">
            <div className="align-right flex flex-col">
              <a href={linkMap[document.source]} target="_blank" className="">
                <div className="w-[8rem] text-sm mr-1 mb-4 mx-auto text-center bg-[#1d3f66] float-right p-3 rounded-lg text-gray-100 invisible lg:visible">
              ...
              {document.abstract?.length ? (
                <a
                  ...
                  target="_blank"
                >
                  <div className="w-[8rem] text-center mx-auto text-sm mr-1 bg-[#1d3f66] float-right p-3 rounded-lg text-gray-100 invisible lg:visible">
                    📄 Abstract
                  </div>
                </a>
              ) : (
